  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> shoesmart
      </div>
      <p class="nero__text">
      </p>
    </div>
...
$headers .= "Content-type: text/html\r\n";
 ...
 $insert_customer = "INSERT INTO `customers` (`customer_name`, `customer_email`, `customer_pass`, `customer_country`, `customer_city`, `customer_contact`, `customer_address`, `customer_image`, `customer_ip`,`pincode`) values ('$c_name','$c_email','$c_pass','$c_country','$c_city','$c_contact','$c_address','$c_image','$c_ip','$c_pincode')";


print_r($run_customer = mysqli_query($con,$insert_customer));
